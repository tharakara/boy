...
class Command extends LineAPI {
    ...
    OnOff() {
        if(this.isAdminOrBot(this.messages.from)){
            ...
            this._sendMessage(this.messages,`คุณไม่ใช่แอดมิน ไม่มีสิทธิ์สั่งการนะ`);
        }
    }
    ...
    async getSpeed() {
        ...
        await this._sendMessage(this.messages, 'กำลังทดสอบระบบ...รอสัครู่');
    ...
    creator() {
        let msg = {
            ...
            contentPreview: null,
            contentMetadata: 
            { mid: 'uaf5fee25d6ae8cc464c6531026ec40da',
            displayName: '@@@KT432@@@' }
        }
